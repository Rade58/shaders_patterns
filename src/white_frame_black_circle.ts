...
import vertexShader from "./shaders/white_frame_black_circle/vertex.glsl";
import fragmentShader from "./shaders/white_frame_black_circle/fragment.glsl";

// ---- pattern: white frame black circle ----
//
// we don't have gradient and I assume we are going to use
// step function
// ------------------------------------
// ------------ gui -------------------
