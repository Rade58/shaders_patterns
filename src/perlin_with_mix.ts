...
import vertexShader from "./shaders/perlin_with_mix/vertex.glsl";
import fragmentShader from "./shaders/perlin_with_mix/fragment.glsl";

// ---- pattern: perlin noise with mix ----
//
// previous example but we use mix function to add some color
// since we used just white and black and their combinations
