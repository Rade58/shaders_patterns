...
import vertexShader from "./shaders/changing_edge/vertex.glsl";
import fragmentShader from "./shaders/changing_edge/fragment.glsl";

// ---- Drawing shapes with uv coordinates: altering edge ----

// we will change edge of a step function to play around a little bit
// -----------------------------------------------------------
