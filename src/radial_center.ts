...
import vertexShader from "./shaders/radial_center/vertex.glsl";
import fragmentShader from "./shaders/radial_center/fragment.glsl";

// ---- pattern: radial gradient in center of the plane ----
//
// we are using `length` like in previous example but we are
// offseting to create radial gradient in center of the plane
// ------------------------------------
// ------------ gui -------------------
