...
import vertexShader from "./shaders/sinus_thing/vertex.glsl";
import fragmentShader from "./shaders/sinus_thing/fragment.glsl";

// ---- pattern: sinus thing ----
//
// in previous example we had pattern with black background
// and white ring which wasn't easy to make
// we got that when we substracted our step function from 1.0

// but now we use trigonometry to have more random looking
// "ring", it is not ring anymore, it is random doodle when you
// look at it but it is closed
