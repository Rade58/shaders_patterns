...
import vertexShader from "./shaders/angles_and_circular/vertex.glsl";
import fragmentShader from "./shaders/angles_and_circular/fragment.glsl";

// ---- pattern: angles and circular ----
//
// gradiet is going in circle, so colors are changing in circle
// and center of the circle is in center of the plane
// ------------------------------------
// ------------ gui -------------------
