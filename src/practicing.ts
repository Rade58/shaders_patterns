...
import vertexShader from "./shaders/practicing/vertex.glsl";
import fragmentShader from "./shaders/practicing/fragment.glsl";

// ---- Drawing shapes with uv coordinates: Practicing ----
//
