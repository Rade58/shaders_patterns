...
import vertexShader from "./shaders/stain_frequency/vertex.glsl";
import fragmentShader from "./shaders/stain_frequency/fragment.glsl";

// ---- pattern: stain frequency ----
//
// previous example but we increasy frequency in sinus function
// to get some result
// ------------------------------------
// ------------ gui -------------------
