...
import vertexShader from "./shaders/inverse_radial_center/vertex.glsl";
import fragmentShader from "./shaders/inverse_radial_center/fragment.glsl";

// ---- pattern: inverse radial gradient in center of the plane ----
//
// we are substracting from 1.0 to get cicular gradient with
// white at the center, and like in previous example
// center og gradient will be inside center of the plane
// ------------------------------------
// ------------ gui -------------------
