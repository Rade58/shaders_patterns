...
import vertexShader from "./shaders/distance/vertex.glsl";
import fragmentShader from "./shaders/distance/fragment.glsl";

// ---- pattern: radial gradient in center of the plane
//                                      but we use `distance` ----
//
// we are using `distance`
// to create same thing we did in previous example
// ------------------------------------
// ------------ gui -------------------
