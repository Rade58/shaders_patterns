...
import vertexShader from "./shaders/black_and_white_frame_intersection/vertex.glsl";
import fragmentShader from "./shaders/black_and_white_frame_intersection/fragment.glsl";

// ---- pattern ----
// black and white frame intersection
// we have black frame and white frame pattern from previous
// two examplel
// We wanyt to multiply them together
// -----------------------------------------------------------
