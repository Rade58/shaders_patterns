...
import vertexShader from "./shaders/white_frame_inversion/vertex.glsl";
import fragmentShader from "./shaders/white_frame_inversion/fragment.glsl";

// ---- pattern ----
// white frame pattern from previous lesson,
// just substracting it from 1.0
// you will get black frame arounf white square
// and this will not be obvious to you since
// we have black background
// -----------------------------------------------------------
