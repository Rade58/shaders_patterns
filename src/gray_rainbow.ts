...
// ---- pattern: gray rainbow ----

// **** WE SWITHED TO USING `ShaderMaterial` over `RawShaderMaterial` ****
// **** because we need functions that are already implemented
// **** in ShaderMaterial and they are missing in RawShaderMaterial
// **** like function `round` we are using in this lesson

// we made some alteration in vertex shader
// to remove duplicate declarations, since
// with ShaderMaterial some things are already declared

// pattern whwew you have gray nuances from black to white
// but with sharp separation
// which probably means we will use step
// function
// -----------------------------------------------------------
