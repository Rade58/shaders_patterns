...
import vertexShader from "./shaders/perlin_with_sin/vertex.glsl";
import fragmentShader from "./shaders/perlin_with_sin/fragment.glsl";

// ---- pattern: perlin noise with sin ----
//
