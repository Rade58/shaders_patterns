...
import vertexShader from "./shaders/dark_ring_gradient/vertex.glsl";
import fragmentShader from "./shaders/dark_ring_gradient/fragment.glsl";

// ---- pattern: dark ring gradient ----
//
//
// ------------------------------------
// ------------ gui -------------------
