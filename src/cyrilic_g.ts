...
import vertexShader from "./shaders/cyrilic_g/vertex.glsl";
import fragmentShader from "./shaders/cyrilic_g/fragment.glsl";

// ---- Grid pattern - cyrilic г ----
// we will do some offset with modulo divident to create cyrilic г
// pattern
//
// -----------------------------------------------------------
