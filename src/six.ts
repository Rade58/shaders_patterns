...
import vertexShader from "./shaders/six/vertex.glsl";
import fragmentShader from "./shaders/six/fragment.glsl";

// ---- Drawing shapes with uv coordinates: Pattern six ----
//
// grayscale that changes over y
// but it is entirely white but little blackness starts at the bottom
