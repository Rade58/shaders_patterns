...
import vertexShader from "./shaders/oposite_cyrilic_g/vertex.glsl";
import fragmentShader from "./shaders/oposite_cyrilic_g/fragment.glsl";

// ---- Grid pattern - oposite cyrilic г ----
//
// we want to create pattern where we have cyrilic g pointing
// to the oposite direction
// we need to separate our code in more variables for this
// -----------------------------------------------------------
