...
import vertexShader from "./shaders/angles_and_offset/vertex.glsl";
import fragmentShader from "./shaders/angles_and_offset/fragment.glsl";

// ---- pattern: angles and offset ----
//
// we just introduce offset to one of the arguments of atan function
// ------------------------------------
// ------------ gui -------------------
