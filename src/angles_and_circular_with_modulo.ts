...
import vertexShader from "./shaders/angles_and_circular_with_modulo/vertex.glsl";
import fragmentShader from "./shaders/angles_and_circular_with_modulo/fragment.glsl";

// ---- pattern: angles and circular with modulo ----
//
// previous example just with modulo
// ------------------------------------
// ------------ gui -------------------
