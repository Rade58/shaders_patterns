...
import vertexShader from "./shaders/little_white_segments_over_x/vertex.glsl";
import fragmentShader from "./shaders/little_white_segments_over_x/fragment.glsl";

// ---- Drawing shapes with uv coordinates: little white stripes ----
//                                           but over x axis

// same pattern like in previous example, but we are using
// x cordinate from the uv coordinets, instead of y coordineate
// we used before
// -----------------------------------------------------------
