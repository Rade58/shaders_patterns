...
import vertexShader from "./shaders/four_pointed_star_rotated/vertex.glsl";
import fragmentShader from "./shaders/four_pointed_star_rotated/fragment.glsl";

// ---- pattern: four pointed star but rotated ----
//
// roataing pattern from previous example with function
// we copied from somewhere
