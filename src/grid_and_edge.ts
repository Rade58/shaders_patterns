...
import vertexShader from "./shaders/grid_and_edge/vertex.glsl";
import fragmentShader from "./shaders/grid_and_edge/fragment.glsl";

// ---- Grid pattern - altering edge of the step function ----
//
// We will change some values from the previous example
// it will be the edge or threshold of the step function

// this will increse or decrese "white spots" by y or x
// depending of which step function call, we will change edge argument
