...
import vertexShader from "./shaders/stripes_with_ternary/vertex.glsl";
import fragmentShader from "./shaders/stripes_with_ternary/fragment.glsl";

// ---- Drawing shapes with uv coordinates: stripes with ternary ----
// ths will be a black and white stripes pattern like before
// but instead if else we are using ternary
//
// But same rule of thumb goes for ternary, just as we told you
// for if statements:
// Don't use it, it is bad for performance
