...
import vertexShader from "./shaders/stain/vertex.glsl";
import fragmentShader from "./shaders/stain/fragment.glsl";

// ---- pattern: stain ----
//
// same as previous example but we are adding stuff, also to another
// uv coordinate
// ------------------------------------
// ------------ gui -------------------
