...
import vertexShader from "./shaders/bars_again/vertex.glsl";
import fragmentShader from "./shaders/bars_again/fragment.glsl";

// ---- Drawing shapes with uv coordinates: bars with modulo, practicing ----
//
