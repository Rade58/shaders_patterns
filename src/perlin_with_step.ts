...
import vertexShader from "./shaders/perlin_with_step/vertex.glsl";
import fragmentShader from "./shaders/perlin_with_step/fragment.glsl";

// ---- pattern: perlin noise with step ----
//
// previous example but we use step
// ------------------------------------
// ------------ gui -------------------
