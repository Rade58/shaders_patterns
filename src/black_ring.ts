...
import vertexShader from "./shaders/black_ring/vertex.glsl";
import fragmentShader from "./shaders/black_ring/fragment.glsl";

// ---- pattern: black ring ----
//
// pattern where we have white background
// and a black ring
// here again we need to use step among other things
// since we don't have gradient

// we combine `step` with previous example

// this like we are drowing a circle on the white paper
// and it is actually hard to do, we use `step`, `abs` and `distance`
// functions

// and if you want white ring on a black background
