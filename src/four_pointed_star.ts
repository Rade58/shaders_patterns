...
import vertexShader from "./shaders/four_pointed_star/vertex.glsl";
import fragmentShader from "./shaders/four_pointed_star/fragment.glsl";

// ---- pattern: four pointed star ----
//
// a combination of two previous example
