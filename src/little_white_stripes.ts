...
import vertexShader from "./shaders/little_white_stripes/vertex.glsl";
import fragmentShader from "./shaders/little_white_stripes/fragment.glsl";

// ---- Drawing shapes with uv coordinates: little white stripes ----

// we are going to use step function but this time we are going
// to increase threshold we explained in previous lesson
// -----------------------------------------------------------
