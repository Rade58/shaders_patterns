...
import vertexShader from "./shaders/length/vertex.glsl";
import fragmentShader from "./shaders/length/fragment.glsl";

// ---- pattern: using length ----
//
// we all know how uv coordinates go
// well, you can use length any coordinate you want
// you can also pass entire uv vec2 as an argument
// to length function
// to get a pattern where source of the pattern is in coordinate 0 0
// which is bottom left corner
// and pattern from black to white goes radialy that way to the
// top right corner
// so we get some radial gradient, it is gray but it is radial

// you can pass single ui coordiante but that won't create radial
// gradient
