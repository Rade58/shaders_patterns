...
import vertexShader from "./shaders/white_frame/vertex.glsl";
import fragmentShader from "./shaders/white_frame/fragment.glsl";

// ---- pattern ----

// white frame (we will be using step function in this case)
// we are continuing previous lesson, just we are using
// mentioned function
// -----------------------------------------------------------
