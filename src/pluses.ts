...
import vertexShader from "./shaders/pluses/vertex.glsl";
import fragmentShader from "./shaders/pluses/fragment.glsl";

// ---- Grid pattern - pluses ----
//
// again, we will add some offset to create pluses pattern
//
// -----------------------------------------------------------
