...
import vertexShader from "./shaders/crossing_stripes/vertex.glsl";
import fragmentShader from "./shaders/crossing_stripes/fragment.glsl";

// ---- Drawing shapes with uv coordinates ----
//
// Pattern with both vUv.x  and   vUv.y
//
// this time we will build patter that has white and black segments
// obver y and, white and black segmants over x
// -----------------------------------------------------------
