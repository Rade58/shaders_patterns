...
import vertexShader from "./shaders/four_pointed_star_rotated_pi/vertex.glsl";
import fragmentShader from "./shaders/four_pointed_star_rotated_pi/fragment.glsl";

// ---- pattern: four pointed star but rotated and we use pi ----
//
// roataing pattern from previous example with function
// we copied from somewhere and we also use pi
// which we copied and hardcoded
