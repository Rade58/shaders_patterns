...
import vertexShader from "./shaders/gray_rainbow_with_floor/vertex.glsl";
import fragmentShader from "./shaders/gray_rainbow_with_floor/fragment.glsl";

// ---- pattern: gray rainbow ----

// same as previous example, but instead of `round` we are using `floor`
// function
// -----------------------------------------------------------
