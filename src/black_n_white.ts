...
import vertexShader from "./shaders/black_n_white/vertex.glsl";
import fragmentShader from "./shaders/black_n_white/fragment.glsl";

// ---- Drawing shapes with uv coordinates ----

// Observations about black and white
