...
import vertexShader from "./shaders/with_max/vertex.glsl";
import fragmentShader from "./shaders/with_max/fragment.glsl";

// ---- pattern - gradient: ----

// previous example, we are just using max instead of min function
// to get something
//
// -----------------------------------------------------------
