...
import vertexShader from "./shaders/small_light_circle_better/vertex.glsl";
import fragmentShader from "./shaders/small_light_circle_better/fragment.glsl";

// ---- pattern: small light circle, but it looks better ----
//
// white small circle in the center surounded by dark gray, very dark
// ------------------------------------
// ------------ gui -------------------
